...
@section('breadcrumb-title', 'All Orders')
@section('content')
<div class="content">
                                ...
                                <table id="onGoingOrders" class="table dataTable no-footer" role="grid" aria-describedby="distributortable_info">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td>
                                                <a href="{{route('admin.order.changeStatus', [$order->id, "progress"])}}" class="btn btn-sm btn-primary">Change Status</a>
                                                <a href="{{route('admin.order.viewSingle', $order->id)}}"><i class="fa fa-eye fa-2x" style="color: #0e2b57"></i></a>
                                            </td>
                                        </tr>
                                        @endif
                                        @empty
                                    ...
                                    @forelse($orders as $order)
                                        @if($order->status == "progress")
                                            <tr role="row">
                                                ...
                                                <td>{{$order->due_date}}</td>
                                                <td>
                                                    <a href="{{route('admin.order.changeStatus', [$order->id, "complete"])}}" class="btn btn-sm btn-primary">Change Status</a>
                                                    <a href="{{route('admin.order.viewSingle', $order->id)}}"><i class="fa fa-eye fa-2x" style="color: #0e2b57"></i></a>
                                                </td>
                                            </tr>
                                        @endif
                                    ...
                                    @forelse($orders as $order)
                                        @if($order->status == "complete")
                                            <tr role="row">
                                                ...
                                                <td>{{$order->due_date}}</td>
                                                <td>
                                                    <a href="{{route('admin.order.changeStatus', [$order->id, "deliver"])}}" class="btn btn-sm btn-primary">Change Status</a>
                                                    <a href="{{route('admin.order.viewSingle', $order->id)}}"><i class="fa fa-eye fa-2x" style="color: #0e2b57"></i></a>
                                                </td>
                                            </tr>
                                        @endif
