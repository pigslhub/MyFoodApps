...
<div class="page-sidebar">
  ...
  <div class="sidebar custom-scrollbar">
    <div class="sidebar-user text-center">
      <div><img class="img-60 rounded-circle" src="<?php echo e(auth('shop')->user()->avatar); ?>" alt="#">
        <div class="profile-edit"><a href="#" target="_blank"><i data-feather="edit"></i></a></div>
      </div>
      <h6 class="mt-3 f-14"><?php echo e(auth('shop')->user()->name); ?></h6>
      <p><?php echo e(auth('shop')->user()->email); ?></p>
    </div>
