<?php $__env->startSection('breadcrumb-title', 'All Orders'); ?>
                                ...
                                <table id="onGoingOrders" class="table dataTable no-footer" role="grid" aria-describedby="distributortable_info">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.order.changeStatus', [$order->id, "progress"])); ?>" class="btn btn-sm btn-primary">Change Status</a>
                                                <a href="<?php echo e(route('admin.order.viewSingle', $order->id)); ?>"><i class="fa fa-eye fa-2x" style="color: #0e2b57"></i></a>
                                            </td>
                                        </tr>
                                        <?php endif; ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php if($order->status == "progress"): ?>
                                            <tr role="row">
                                                ...
                                                <td><?php echo e($order->due_date); ?></td>
                                                <td>
                                                    <a href="<?php echo e(route('admin.order.changeStatus', [$order->id, "complete"])); ?>" class="btn btn-sm btn-primary">Change Status</a>
                                                    <a href="<?php echo e(route('admin.order.viewSingle', $order->id)); ?>"><i class="fa fa-eye fa-2x" style="color: #0e2b57"></i></a>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php if($order->status == "complete"): ?>
                                            <tr role="row">
                                                ...
                                                <td><?php echo e($order->due_date); ?></td>
                                                <td>
                                                    <a href="<?php echo e(route('admin.order.changeStatus', [$order->id, "deliver"])); ?>" class="btn btn-sm btn-primary">Change Status</a>
                                                    <a href="<?php echo e(route('admin.order.viewSingle', $order->id)); ?>"><i class="fa fa-eye fa-2x" style="color: #0e2b57"></i></a>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/LocalDisk2/Projects/Food Project/MyFoodApps/resources/views/admin/order/viewAll.blade.php ENDPATH**/ ?>