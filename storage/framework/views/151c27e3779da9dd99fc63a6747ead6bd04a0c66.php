    ...
    <div class="nav-right col p-0">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown">
          <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle" src="<?php echo e(auth('admin')->user()->avatar); ?>" alt="header-user">
...
<!-- Page Header Ends -->
<?php /**PATH E:\Sir Imran\MyFoodApps\resources\views/layouts/admin/header.blade.php ENDPATH**/ ?>