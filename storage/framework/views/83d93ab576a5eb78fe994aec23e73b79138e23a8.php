                ...
                <div class="row">
                    <div class="col-12 mainNavCol">
                        ...
                        <div class="logo mainNavCol">
                            <a href="/">
                                <img src="<?php echo e(asset('assets/ast/img/logo.png')); ?>" class="img-fluid" alt="Logo">
                            </a>
                        </div>
                        <!-- logo -->
                        ...
                        <div class="right-side fw-700 mainNavCol">
                            ...
                            <div class="gem-points">
                                <a href="<?php echo e(route('user.index')); ?>"> <i  class="fas fa-user"></i>
    ...
    <section class="about-us-slider swiper-container p-relative">
        <div class="swiper-wrapper">
            <div class="swiper-slide slide-item">
                <img src="<?php echo e(asset('assets/ast/img/about/blog/1920x700/banner-1.jpg')); ?>" class="img-fluid full-width" alt="Banner">
            ...
            <div class="swiper-slide slide-item">
                <img src="<?php echo e(asset('assets/ast/img/about/blog/1920x700/banner-2.jpg')); ?>" class="img-fluid full-width" alt="Banner">
                <div class="transform-center">
                    <div class="container">
            ...
            <div class="swiper-slide slide-item">
                <img src="<?php echo e(asset('assets/ast/img/about/blog/1920x700/banner-3.jpg')); ?>" class="img-fluid full-width" alt="Banner">
                <div class="transform-center">
                    <div class="container">
                    ...
                    <div class="product-box mb-md-20">
                        <div class="product-img">
                            <a href="https:///save/_embed/http://slidesigma.com/themes/html/munchbox/restaurant.html">
                                <img src="<?php echo e(asset('assets/ast/img/restaurants/255x104/order-1.jpg')); ?>" class="img-fluid full-width" alt="product-img">
                            </a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product-box mb-xl-20">
                                <div class="product-img">
                                    <a href="https:///save/_embed/http://slidesigma.com/themes/html/munchbox/restaurant.html">
                                        <img src="<?php echo e(asset('assets/ast/img/restaurants/255x150/shop-23.jpg')); ?>" class="img-fluid full-width" alt="product-img">
                                    </a>
...
<?php echo $__env->make('layouts.default-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Sir Imran\MyFoodApps\resources\views/default.blade.php ENDPATH**/ ?>